...
#pragma pack(1)
  struct Unit
  {
    ...
    /*0x064*/ BW::UnitTypeID                      unitType;               /**< Specifies the type of unit. */
    /*0x066*/ _UNKNOWN                            _9[2];
    ...
    /*0x098*/ BW::UnitTypeID                      buildQueue[5];      /**< Queue of units to build. Note that it doesn't begin with index 0, but with #buildQueueSlot index. */
