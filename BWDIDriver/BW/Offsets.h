...
namespace BW
{
  ...
  {
    u32  playerID;
    u32  stormID; // 0xFFFFFFFF if not used
    u8   type;
    u8   race;
    u8   force;
    char name[25];
    ...
    {
      return name[0] != 0 || playerID == 11;
    }
  };
  static PlayerInfo *BWDATA_Players = (PlayerInfo*) 0x0057EEE0;
  static PlayerInfo *BWDATA_LobbyPlayers  = (PlayerInfo*) 0x0059BDB0;
  static PlayerInfo *BWDATA_LobbyPlayers2 = (PlayerInfo*) 0x0059BF60;
  static RaceID* BWDATA_SingleplayerSlotRaces = (RaceID*) 0x0057F266;
  ...
  static u32    BWCALLFIX_Game_RECV         =             0x00486FB5;
// void __userpurge Game_RECV(char *a1<eax>, int dataLen, bool asReplay)
  static void (__stdcall *BWFXN_Game_RECV)(int,bool)   = (void (__stdcall*)(int,bool)) 0x004865D0;
  ...
  //------------------------------------------- CLIST DATA ---------------------------------------------------
  static Unit**         BWDATA_UnitNodeChain_Visible_First  = (Unit**)       0x00628430;  // 1.16.1
  static Unit**         BWDATA_UnitNodeChain_Visible_Last   = (Unit**)       0x0059CC9C;  // 1.16.1 - unreliable could be 0x0059CD10, holds the same value...
  static Unit**         BWDATA_UnitNodeChain_Hidden_First   = (Unit**)       0x006283EC;  // 1.16.1
  static Unit**         BWDATA_UnitNodeChain_Hidden_Last    = (Unit**)       0x00628428;  // 1.16.1
  static Unit**         BWDATA_UnitNodeChain_Unused_First   = (Unit**)       0x00628438;  // 1.16.1
  static Unit**         BWDATA_UnitNodeChain_Unused_Last    = (Unit**)       0x0062843C;  // 1.16.1
  ...
  static Bullet **BWDATA_BulletNodeChain_Visible_First = (Bullet**)0x0064DEAC;
  static Bullet **BWDATA_BulletNodeChain_Visible_Last  = (Bullet**)0x0064DEC4;
  static Bullet **BWDATA_BulletNodeChain_Unused_First  = (Bullet**)0x0064EEDC;
  static Bullet **BWDATA_BulletNodeChain_Unused_Last   = (Bullet**)0x0064EED8;
  ...
  //------------------------------------------- DATA LEVEL ---------------------------------------------------
  /* Mode Stuff */
  static GameTypeID     *BWDATA_gameType       = (GameTypeID*)  0x00596820;
  ...
  */
  ...
  static u32 *BWDATA_selfPlayerID = (u32*) 0x00512688;

  static u32 *BWDATA_g_ActiveNationID = (u32*) 0x00512678; // = 8
  static u32 *BWDATA_g_ActiveHumanID  = (u32*) 0x0051267C; // = 8
  static u32 *BWDATA_g_ActiveStormID  = (u32*) 0x00512680; // = 8
  static u32 *BWDATA_g_LocalNationID  = (u32*) 0x00512684; // = 8
  static u32 *BWDATA_g_LocalHumanID   = (u32*) 0x00512688; // = 8
  static u32 *BWDATA_g_LocalStormID   = (u32*) 0x0051268C; // = 8

  static u32 *BWDATA_g_PlayerHumanIDs = (u32*) 0x0057EE7C; // [8]
  static u32 *BWDATA_g_PlayerNationIDs= (u32*) 0x0057EEC0; // [8]

  static u8  *BWDATA_VisionFilter     = (u8 *) 0x0057EEB9; // flags
  static u8  *BWDATA_VisionFilter2    = (u8 *) 0x0057F0B0; // flags
  ...
  extern char           *BWDATA_StringTableOff; // = dynamically attained in Detours
