...
namespace BW
{
  namespace Command
  {
    ...
    //-------------------------------------- SELECT CONSTRUCTOR ----------------------------------------------
    Select::Select(BW::UnitID *units, unsigned int count)
    {
      u8 finalCount = 0;
    ...
    TrainUnit::TrainUnit(BW::UnitTypeID type)
      : type(type)
    {
    }
    ...
    //--------------------------------------------- MAKE BULDING ---------------------------------------------
    MakeBuilding::MakeBuilding(BW::BuildPosition position, BW::UnitTypeID type)
      : position(position)
      , type(type)
    {
      /*
...
#pragma message("TODO")
    ...
    //--------------------------------------------- INVENT TECH ----------------------------------------------
    Invent::Invent(BW::TechID tech)
      : tech(tech)
    {
    }
    //----------------------------------------------- UPGRADE ------------------------------------------------
    Upgrade::Upgrade(BW::UpgradeID upgrade)
      : upgrade(upgrade)
    {
    }
    //---------------------------------------------- MAKE ADDON ----------------------------------------------
    MakeAddon::MakeAddon(BW::BuildPosition position, BW::UnitTypeID type)
      : always0x24(0x24)
      , position(position)
      , type(type)
    {
    ...
    BuildingMorph::BuildingMorph(BW::UnitTypeID type)
      : type(type)
    {
    }
    //------------------------------------------ CANCEL ADDON ------------------------------------------------
    ...
    //------------------------------------------------- LAND -------------------------------------------------
    Land::Land(BW::BuildPosition position, BW::UnitTypeID type)
      : always0x47(0x47)
      , position(position)
      , type(type)
    {
    ...
    UnitMorph::UnitMorph(BW::UnitTypeID type)
      : type(type)
    {
    }
    //------------------------------------------------ CLOAK -------------------------------------------------
